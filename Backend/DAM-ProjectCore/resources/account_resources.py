...
class ResourceAccountRecovery(DAMCoreResource): #configuració recuperacio contrasenya
    def on_post(self,req,resom*args,**kwargs):
        super(ResourceAccountRecovery, self).on_post(req,resp,*args,**kwargs)
        
        email = req.req.media["email"]
        ...
        try: 
            ...
            */
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <td align="center" bgcolor="#e9ecef">
                    ...
                    <tr>
                        ...
                        <a href="https://anoiashopping.wordpress.com" target="_blank" style="display: inline-block;">
            ...
            message["Subject"]:'[Anoia_Shopping] Recovery account instructions'
